...
batch_size = 128
data_dir = '/home/sunbo/Dropbox/project/DL/learningTF/cifar10/cifar10_data/cifar-10-batches-bin'
...
W_conv1 = weights_variable([5, 5, 3, 64])
...
W_conv2 = weights_variable([5, 5, 64, 64])
b_conv2 = bias_variable([64])

h_conv2 = tf.nn.relu(conv2d(h_pool1, W_conv2) + b_conv2)
h_pool2 = max_pool_2x2(h_conv2)

W_conv3 = weights_variable([5, 5, 64, 10])
